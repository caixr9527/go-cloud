...
type redisConfig struct {
	...
	MinRetryBackoff int64 `yaml:"minRetryBackoff"`
	// Maximum backoff between each retry.
	// Default is 512 milliseconds; -1 disables backoff.
	MaxRetryBackoff int64 `yaml:"maxRetryBackoff"`
	...
	ContextTimeoutEnabled bool `yaml:"contextTimeoutEnabled"`
	...
	DisableIndentity bool `yaml:"disableIndentity"`
